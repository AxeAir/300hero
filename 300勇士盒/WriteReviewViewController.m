...
//    用户ID                      userID
    ...
    NSDictionary *paramters= [NSDictionary dictionaryWithObjectsAndKeys:[NSString stringWithFormat:@"%ld",_pageID],@"pageID",_ReviewText.text,@"content",@"0",@"commentID",@"yeti",@"userID", nil];
